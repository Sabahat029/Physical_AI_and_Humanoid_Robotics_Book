...
import { BitmapDataBox, ParserToolbox } from '../../../parsersEngine/index.js';
import { specifyErrors } from '../../../errors/index.js';

// TODO: Add tests
/* v8 ignore start */
export function generateBitmapDataBoxAssets(
  tokens: SpecifyDesignTokenFormat,
  toolbox: ParserToolbox,
): BitmapDataBox['assets'] {
  ...
  }) as Array<TokenState<'bitmap'> | TokenState<'bitmaps'>>;

  return tokenStates.flatMap(tokenState => {
    if (!tokenState.isToken) return [];
