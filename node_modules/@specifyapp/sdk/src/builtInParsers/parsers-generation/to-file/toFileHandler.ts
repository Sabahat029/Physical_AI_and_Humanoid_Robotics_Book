...
import type { ToFileParserDefinition } from './definition.js';
import type { DeriveBuiltInParserHandlerFromDefinition } from '../../internals/createBuiltInParserDefinition.js';

export const toFileHandler: DeriveBuiltInParserHandlerFromDefinition<
...
> = async (previousDataBox, toolbox, parserOptions, outputConfiguration, _context) => {
  ...
  for (const urlData of urlDataBoxList) {
    ...
    const template =
      parserOptions?.filenameTemplate && typeof parserOptions?.filenameTemplate === 'string'
