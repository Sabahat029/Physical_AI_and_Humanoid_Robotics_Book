...
import type { ToKotlinParserDefinition } from './definition.js';
...
export const toKotlinHandler: DeriveBuiltInParserHandlerFromDefinition<
  ...
  switch (previousDataBox.type) {
    ...
    default: {
      throw new SpecifyError({
        ...
        } is not a valid input for the to-kotlin parser.`,
      });
    }
  }
