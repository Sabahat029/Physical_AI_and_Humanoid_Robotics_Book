...
import type { ToJavascriptParserDefinition } from './definition.js';
...
export const toJavascriptHandler: DeriveBuiltInParserHandlerFromDefinition<
  ...
  switch (previousDataBox.type) {
    ...
    default: {
      throw new SpecifyError({
        ...
        } is not a valid input for the to-javascript parser.`,
      });
    }
  }
