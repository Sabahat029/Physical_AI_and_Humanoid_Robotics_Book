...
import type { ToFlutterParserDefinition } from './definition.js';
import { convertedToDart } from './convertedToDart.js';
import { convertTokens } from './convertTokens.js';
import { DEFAULT_TEMPLATE, validateTemplate } from './template.js';

export const toFlutterHandler: DeriveBuiltInParserHandlerFromDefinition<
  ...
  switch (previousDataBox.type) {
    ...
    default: {
      throw new SpecifyError({
        ...
        } is not a valid input for the to-tailwind parser.`,
      });
    }
  }
