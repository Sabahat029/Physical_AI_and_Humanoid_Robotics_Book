...
import type { ChangeCaseParserDefinition, ChangeCaseParserOptions } from './definition.js';
import {
  camelCase,
  capitalCase,
  constantCase,
...
export const changeCaseHandler: DeriveBuiltInParserHandlerFromDefinition<
  ...
  switch (previousDataBox.type) {
    ...
    default: {
      throw new SpecifyError({
        ...
        }" is not supported by the change-case parser.`,
      });
    }
  }
...
export function changeCaseInner(
  sdtfEngine: SDTFEngine,
  parserOptions: ChangeCaseParserOptions,
