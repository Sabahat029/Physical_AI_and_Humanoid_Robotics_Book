...
import type { FilterParserDefinition } from './definition.js';
import { SpecifyError, specifyErrors } from '../../../errors/index.js';
import { DeriveBuiltInParserHandlerFromDefinition } from '../../internals/createBuiltInParserDefinition.js';

export const filterHandler: DeriveBuiltInParserHandlerFromDefinition<
...
> = async (previousResult, toolbox, parserOptions, _, _context) => {
      ...
      if (tokenState.isFullyResolvable === false && allowUnresolvableAliases === false) {
        throw new SpecifyError({
          ...
          publicMessage: `Allow unresolvable aliases matched :: Token "${tokenState.path.toString()}" has unresolvable references: ${tokenState.aliases
            .reduce<Array<string>>((msgs, alias) => {
  ...
  const dedupe =
    parserOptions.deduplicate && typeof parserOptions.deduplicate === 'function'
