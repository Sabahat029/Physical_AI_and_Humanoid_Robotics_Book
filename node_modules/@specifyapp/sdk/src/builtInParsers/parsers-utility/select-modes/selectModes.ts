...
import type { SelectModesParserDefinition } from './definition.js';
...
export const selectModesHandler: DeriveBuiltInParserHandlerFromDefinition<
  ...
  switch (previousResult.type) {
    ...
    default: {
      throw new SpecifyError({
        ...
        }" is not supported by the select-modes parser.`,
      });
    }
  }
