import { SpecifyColorValue, TokenState } from '@specifyapp/specify-design-token-format';
...
export function updateToken(
  ...
  target: SpecifyColorValue['model'],
  ...
  const updateValue = tokenState.matchJSONValueByType<any | undefined>(
    {
