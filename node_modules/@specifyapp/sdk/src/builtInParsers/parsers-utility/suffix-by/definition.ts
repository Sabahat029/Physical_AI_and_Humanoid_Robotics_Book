...
export const suffixByParserName = 'suffix-by';

export const suffixByParserOptionsSchema = z
  .object({
...
export const suffixByParserDefinition = createBuiltInParserDefinition({
  name: suffixByParserName,
  kind: 'utility',
  hasOptionalOptions: false,
  optionsSchema: suffixByParserOptionsSchema,
