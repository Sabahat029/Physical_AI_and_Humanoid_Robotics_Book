...
import { CssUnresolvableAliasStrategy } from './CssAliasStrategy.js';
import { TemplateRenderer } from '../../../builtInParsers/utils/template.js';
...
export function createUnresolvableAliasToVarStrategy(templates?: {
  ...
  const strategy = ((tokenState, alias) => {
    ...
    if (alias instanceof UnresolvableModeLevelAlias) {
      return tokenState.matchByType<Record<string, string> | string>(
        {
  ...
  }) as CssUnresolvableAliasStrategy<string | Record<string, string>>;
