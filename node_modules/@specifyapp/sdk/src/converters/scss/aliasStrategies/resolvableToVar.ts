...
import {
  renderVariable as renderScssVariable,
  DEFAULT_TEMPLATE,
} from '../../scss/utils/template.js';
...
import { ScssResolvableAliasStrategy } from './ScssAliasStrategy.js';
import {
  TemplateRenderer,
 ...
 */
export function createAliasToVarStrategy(
  template?: string,
  shouldRenderSingleMode = false,
): ScssResolvableAliasStrategy {
  return alias => {
    ...
    if (alias instanceof ResolvableTopLevelAlias) {
      ...
      switch (alias.tokenState.type) {
        case 'transition':
          return modeLevelAliasTransitonToVariables(alias, renderVariable, false) as any;
        case 'textStyle':
        ...
        case 'font':
          return modeLevelAliasFontToVariables(alias, renderVariable, false) as any;
        default:
