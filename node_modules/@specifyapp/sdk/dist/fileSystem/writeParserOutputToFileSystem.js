...
export async function writeParserOutputToFileSystem(output, options) {
    ...
    switch (output.type) {
                ...
                if (file.content.type === 'url') {
                    ...
                    if (response) {
                        ...
                        if (contentType && stringContentType.includes(contentType)) {
                            await writeBufferTextEncodedToFile(filePath, Buffer.from(await response.arrayBuffer()));
                        }
        ...
        default: {
            throw new SpecifyError({
                ...
                output.type} is not supported by the writePipeEngineResultToFileSystem function.`,
            });
        }
    }
    return Array.from(writtenFilePaths);
}
//# sourceMappingURL=writeParserOutputToFileSystem.js.map