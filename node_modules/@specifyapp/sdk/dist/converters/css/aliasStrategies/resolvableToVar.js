...
import { renderVariable as renderVariable_, DEFAULT_TOKEN_TEMPLATE, DEFAULT_TOKEN_NOT_IN_COLLECTION_TEMPLATE, } from '../utils/template.js';
...
export function createAliasToVarStrategy(templates) {
    const renderVariable = rawData => renderVariable_(rawData.collection
        ? templates?.tokenNameTemplate ?? DEFAULT_TOKEN_TEMPLATE
        : templates?.tokenNotInCollectionNameTemplate ?? DEFAULT_TOKEN_NOT_IN_COLLECTION_TEMPLATE, rawData);
    return alias => {
                ...
                switch (alias.tokenState.type) {
                        ...
                        return alias.tokenState
                            ...
                            switch (alias.tokenState.type) {
                                ...
                                case 'textStyle':
                                    ...
                                    return modeLevelAliasTextStyleToVariables(alias, renderVariable, textStyle);
                                case 'font':
                    ...
                    default:
                        return alias.tokenState
                            ...
                            .mapModes(mode => makeCSSAlias(renderVariable(dataOfToken(value.tokenState, mode))))
                            .unwrap())
                            .unwrap();
                    // The any is here to avoid using generics everywhere
                }
