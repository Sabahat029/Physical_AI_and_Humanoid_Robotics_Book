...
export const prefixByHandler = async (previousResult, toolbox, parserOptions, _) => {
    let sdtfEngine;
    ...
    if (!('all' in parserOptions) &&
        ...
        toolbox.populateMessage({
            type: 'warning',
            content: "Couldn't find a pattern in all, token, group or collection, so nothing will be prefixed",
...
export function prefixByInner(engine, options) {
...
//# sourceMappingURL=prefixBy.js.map