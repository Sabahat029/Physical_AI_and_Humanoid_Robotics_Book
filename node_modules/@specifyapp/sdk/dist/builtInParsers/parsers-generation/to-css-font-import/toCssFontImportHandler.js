...
import { convertToFontFaces } from './convertToFontFaces.js';
export const toCssFontImportHandler = async (previous, toolbox, parserOptions, outputOptions, _context) => {
    let sdtfEngine;
        ...
        files: [
            {
                ...
                content: {
                    type: 'text',
                    text: convertToFontFaces(outputs),
                },
            },
        ],
    });
...
//# sourceMappingURL=toCssFontImportHandler.js.map