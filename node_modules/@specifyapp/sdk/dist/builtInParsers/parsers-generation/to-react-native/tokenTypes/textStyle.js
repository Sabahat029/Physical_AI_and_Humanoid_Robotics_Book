...
export function renderTextStyle(textStyle) {
    const variables = renderFont(textStyle.font);
    variables.fontSize = renderDimension(textStyle.fontSize);
    if (!!textStyle.color)
        variables.color = renderColor(textStyle.color);
    if (!!textStyle.textIndent)
        variables.textIndent = renderDimension(textStyle.textIndent);
    if (!!textStyle.lineHeight)
        variables.lineHeight = renderDimension(textStyle.lineHeight);
    ...
    if (!!textStyle.textAlignVertical)
        variables.textAlignVertical = textStyle.textAlignVertical;
    if (!!textStyle.textTransform)
        variables.textTransform = textStyle.textTransform;
    if (!!textStyle.textDecoration)
        variables.textDecoration = textStyle.textDecoration;
    return variables;
}
