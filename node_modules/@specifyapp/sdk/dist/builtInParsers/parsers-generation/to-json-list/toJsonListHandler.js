...
export const toJsonListHandler = async (previousDataBox, toolbox, parserOptions, outputOptions, _context) => {
    let sdtfEngine;
    switch (previousDataBox.type) {
        ...
        default: {
            throw new SpecifyError({
                ...
                publicMessage: `${previousDataBox.type} is not a valid input for the to-json-list parser.`,
            });
        }
    }
    ...
    sdtfEngine.query.getAllNodeStates().forEach(node => {
        if (node.isToken) {
            ...
            if (node.extensions)
                item.extensions = node.extensions;
    ...
    switch (outputOptions?.type) {
        ...
        default: {
            throw new SpecifyError({
                ...
                publicMessage: `The output type ${outputOptions?.type} is not supported by the to-json-list parser.`,
            });
        }
    }
    return {
...
//# sourceMappingURL=toJsonListHandler.js.map