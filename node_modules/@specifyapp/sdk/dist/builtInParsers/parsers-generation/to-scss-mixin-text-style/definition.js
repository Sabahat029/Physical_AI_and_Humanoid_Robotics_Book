...
export const toScssMixinTextStyleParserName = 'to-scss-mixin-text-style';
export const toScssMixinTextStyleParserDefinition = createBuiltInParserDefinition({
    name: toScssMixinTextStyleParserName,
    kind: 'generation',
