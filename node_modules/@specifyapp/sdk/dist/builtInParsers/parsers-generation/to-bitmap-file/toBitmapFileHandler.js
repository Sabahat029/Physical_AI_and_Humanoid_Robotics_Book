import { TreePath, createSDTFEngine, } from '@specifyapp/specify-design-token-format';
...
export const toBitmapFileHandler = async (previous, toolbox, parserOptions, outputOptions, _context) => {
    let tokenTree;
    let sdtfEngine;
    switch (previous.type) {
        ...
        default: {
            throw new SpecifyError({
                ...
                publicMessage: `${previous.type} is not a valid input for the to-bitmap-file parser.`,
            });
        }
    }
...
//# sourceMappingURL=toBitmapFileHandler.js.map