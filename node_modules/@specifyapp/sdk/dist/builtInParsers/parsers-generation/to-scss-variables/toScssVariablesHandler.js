...
import { DEFAULT_TEMPLATE } from '../../../converters/scss/utils/template.js';
export const toScssVariablesHandler = async (previousDataBox, toolbox, parserOptions, outputOptions, _context) => {
    let sdtfEngine;
    ...
    if (outputOptions?.type !== 'file')
        throw new SpecifyError({
            ...
            publicMessage: `The output type ${outputOptions?.type} is not supported by the to-scss-variable parser.`,
        });
    const defaultOptions = {
        tokenNameTemplate: DEFAULT_TEMPLATE,
        shouldRenderSingleMode: false,
    };
        ...
        files: [
            {
                ...
                content: { type: 'text', text: convertTokens(sdtfEngine, finalOptions) },
            },
        ],
    });
    return {
...
//# sourceMappingURL=toScssVariablesHandler.js.map