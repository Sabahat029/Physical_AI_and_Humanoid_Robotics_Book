...
export function textStyleToKotlin(textStyle) {
    let output = `TextStyle(fontFamily = FontFamily(${fontToKotlin(textStyle.font)}), fontWeight = ${fontWeightToKotlin(textStyle.font.weight)}, fontStyle = ${textStyle.font.style === 'normal' ? 'FontStyle.Normal' : 'FontStyle.Italic'},`;
    if (textStyle.color) {
    ...
    if (textStyle.textDecoration &&
        ...
        output += ` textDecoration = ${textStyle.textDecoration === 'underline'
