...
export const toSdtfHandler = async (previousDataBox, toolbox, _parserOptions, outputConfiguration, _context) => {
    /* v8 ignore start */
    let sdtfEngine;
    let sdtfTokenTree;
    switch (previousDataBox.type) {
        ...
        default: {
            throw new SpecifyError({
                ...
                publicMessage: `The input type ${previousDataBox.type} is not supported by the to-sdtf parser.`,
            });
        }
    }
...
//# sourceMappingURL=toSdtfHandler.js.map