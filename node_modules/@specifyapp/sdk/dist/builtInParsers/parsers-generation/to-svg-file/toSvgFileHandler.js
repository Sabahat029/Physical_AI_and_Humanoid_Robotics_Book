...
import { createSDTFEngine, deepSetJSONValue, TreePath, } from '@specifyapp/specify-design-token-format';
...
export const toSvgFileHandler = async (previousDataBox, toolbox, parserOptions, outputOptions, _context) => {
    let tokenTree;
    let sdtfEngine;
    let vectorAssets;
    switch (previousDataBox.type) {
        ...
        case 'SDTF Engine': {
            ...
            vectorAssets = (await generateVectorDataBoxAndPullSvgsContent(previousDataBox.engine.renderJSONTree(), toolbox)).assets;
            break;
        }
        default:
            throw new SpecifyError({
                errorKey: specifyErrors.PARSERS_ENGINE_INVALID_PARSER_INPUT.errorKey,
                publicMessage: `${previousDataBox.type} is not a valid input for the to-svg-file parser.`,
            });
    }
...
//# sourceMappingURL=toSvgFileHandler.js.map