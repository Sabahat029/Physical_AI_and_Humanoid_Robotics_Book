...
function isVersion17OrNewer(version) {
    const [major, minor, patch] = version.split('.').map(Number);
    return major > 17 || (major === 17 && minor >= 0 && patch >= 0);
}
export function generateDefaultJSXTemplate(svg, { path, mode, }, options) {
    ...
    return `${prefix}${reactImport}export ${options.isExportDefault ? 'default' : 'const ' + varName + ' ='} () => (${svgStringToJSXString(svg)});${suffix}`;
}
//# sourceMappingURL=generateDefaultJSXTemplate.js.map