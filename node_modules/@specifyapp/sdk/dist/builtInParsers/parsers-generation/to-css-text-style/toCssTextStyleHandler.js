...
import { convertToCssClasses } from './convertToCssClasses.js';
export const toCssTextStyleHandler = async (previous, toolbox, parserOptions, outputOptions, _context) => {
    let sdtfEngine;
    switch (previous.type) {
        ...
        default: {
            throw new SpecifyError({
                ...
                publicMessage: `${previous.type} is not a valid input for the to-css-custom-properties parser.`,
            });
        }
    }
    ...
    const { outputs, warningMessages } = convertTokens(sdtfEngine.query.getAllTokenStates(), finalOptions);
        ...
        files: [
            {
                ...
                content: {
                    type: 'text',
                    text: convertToCssClasses(outputs),
                },
            },
        ],
    });
...
//# sourceMappingURL=toCssTextStyleHandler.js.map