...
export class SpecifyClient {
     ...
     */
    async authenticate(personalAccessToken) {
     ...
     */
    async getSDTFClientByRepositoryName(repositoryName) {
        const { payload: repositoryInformation } = await this.#http.getMyRepositoryByName(repositoryName);
...
//# sourceMappingURL=SpecifyClient.js.map