 ...
 */
function color(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
 ...
 */
function dimension(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
 ...
 */
function changeCase(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
 ...
 */
function replaceString(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
 ...
 */
function prefixBy(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
 ...
 */
function suffixBy(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
 ...
 */
function makeLineHeightRelative(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
        makeLineHeightRelativeInner(engine, options, new ParserToolbox({ pipelineName: 'makeLineHeightRelative' }));
    };
}
/**
 ...
 * @param applyTo
 */
function roundNumber(options, applyTo) {
    return (engine, applyToInner) => {
        options.applyTo = applyTo ?? applyToInner;
