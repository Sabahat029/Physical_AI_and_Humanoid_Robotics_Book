...
export const makeSpecifyFontWeightValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.union([z.number().min(1).max(1000), specifyFontWeightNomenclatureSchema]));
