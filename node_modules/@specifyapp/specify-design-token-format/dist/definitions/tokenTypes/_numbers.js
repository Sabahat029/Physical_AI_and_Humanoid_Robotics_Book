...
import { specifyArcDegreeNumberTypeName, specifyIntegerNumberTypeName, specifyPercentageNumberTypeName, specifyPositiveIntegerNumberTypeName, specifyPositiveNumberTypeName, specifyRGBColorNumberTypeName, specifyZeroToOneNumberTypeName, } from '../designTokenTypeNames.js';
/* ==========================================
   Utility Specify Value Types
============================================= */
// Integer Number ]-∞,+∞[
export const makeSpecifyIntegerNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().int());
...
export const makeSpecifyZeroToOneNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().min(0).max(1));
...
export const makeSpecifyArcDegreeNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().min(0).lt(360));
...
export const makeSpecifyRGBColorNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().min(0).max(255));
...
// Positive Number [0,+∞[
export const makeSpecifyPositiveNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().min(0));
...
export const makeSpecifyPositiveIntegerNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().int().min(0));
...
export const makeSpecifyPercentageNumberValueSchema = makeUnionWithModeAndValueLevelAliasValue(z.number().min(0).max(100));
