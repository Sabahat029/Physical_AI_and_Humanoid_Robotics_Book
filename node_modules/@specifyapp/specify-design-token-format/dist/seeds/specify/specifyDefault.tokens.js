export const specifyDefaultSeed = {
    primitive: {
    ...
    content: {
        ...
        copy: {
            ...
            description: {
                $type: 'string',
                $value: {
                    French: 'Ameliorez votre systeme de conception en creant votre propre source de verite, ameliorez la collaboration entre la conception et le developpement et reduisez le travail manuel.',
                    English: 'Enhance your design system by creating your own source of truth, improve collaboration between design and development and reduce manual work.',
                    Spanish: 'Mejore su sistema de dise�o creando su propia fuente de verdad, mejore la colaboracion entre dise�o y desarrollo y reduzca el trabajo manual.',
                },
            },
        },
        label: {
