export const openColorSeed = {
    primitive: {
        color: {
            $description: 'Open Color is an open-source color scheme optimized for UI like font, background, border, etc. — https://yeun.github.io/open-color/',
