...
import { specifyColorModelNames, } from '../../definitions/tokenTypes/color.js';
import { getMockedHexadecimalColorStringValue } from './_strings.js';
import { getMockedArcDegreeNumberValue, getMockedPercentageNumberValue, getMockedPositiveNumberValue, getMockedRGBColorNumberValue, getMockedZeroToOneNumberValue, } from './_numbers.js';
export function getMockedColorValue(override, model) {
    if (override) {
        return override;
    }
