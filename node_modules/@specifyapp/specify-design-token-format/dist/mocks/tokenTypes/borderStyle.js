import { specifyNamedBorderStyleValues, } from '../../definitions/tokenTypes/borderStyle.js';
...
export function getMockedBorderStyle(override, namedStyleOnly = false) {
    if (override) {
        return override;
    }
    ...
    return {
        dashArray: Array.from(new Array(pickRandomNumberInRange(2, 4))).map(() => getMockedDimensionValue()),
