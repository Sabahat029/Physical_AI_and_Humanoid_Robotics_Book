...
export function setInSDTFTree(mutableRecord, path, value) {
    if (path.length === 0) {
        if (typeof value === 'object' && !Array.isArray(value) && value !== null) {
            ...
            throw new SDTFError('SDTF_INTERNAL_DESIGN_ERROR', `Cannot set value of type "${isArray ? 'array' : typeof value}" to root of object`);
        }
    }
