...
import { SDTFNodeState, ViewSelectorOptions } from './state/TreeState.js';
import { QueryResult, SDTFQuery } from './query/index.js';
import { SDTFEngineSerializedMetadata, SDTFEngineSerializedState } from './SDTFEngineSerializedState.js';
...
import { PickSpecifyDesignToken, SpecifyDesignToken, SpecifyDesignTokenCollectionProperties, SpecifyDesignTokenGroupProperties, SpecifyDesignTokenTypeName } from '../definitions/index.js';
import { GroupState } from './state/GroupState.js';
import { CollectionState } from './state/CollectionState.js';
import { AliasReference, ResolvableAliasReference, ResolvedStatefulAliasReference, StatefulAliasReference, UnresolvableAliasReference, UnresolvableStatefulAliasReference } from './state/AliasReferenceSet.js';
import { SerializedView } from './state/ViewState.js';
import { TreePath } from './state/path/TreePath.js';
export declare function createSDTFEngine(tokenTree?: unknown, metadata?: SDTFEngineSerializedMetadata): SDTFEngine;
export declare function isSDTFEngine(data: any): data is SDTFEngine;
export type SDTFEngine = {
    ...
    mutation: {
         ...
         */
        updateCollectionDescription: (payload: {
            description: string;
            atPath: TreePath;
        }) => void;
        /**
         ...
         */
        updateGroupDescription: (payload: {
            description: string;
            atPath: TreePath;
        }) => void;
        /**
         ...
         */
        updateTokenDescription: (payload: {
            description: string;
            atPath: TreePath;
        }) => void;
        /**
         ...
         */
        updateTokenValue: <Type extends SpecifyDesignTokenTypeName = SpecifyDesignTokenTypeName>(payload: {
            atPath: TreePath;
         ...
         * @param payload
         */
        resolveTokenValueAliases: (payload: {
            atPath: TreePath;
        }) => void;
        /**
         ...
         */
        updateTokenModeValue: <Type extends SpecifyDesignTokenTypeName = SpecifyDesignTokenTypeName>(payload: {
            mode: string;
            atPath: TreePath;
            value?: PickSpecifyDesignToken<Type, string, true, false>['$value'];
        }) => void;
         ...
         * @param value - The new value for the mode
         */
        createTokenModeValue: <Type extends SpecifyDesignTokenTypeName = SpecifyDesignTokenTypeName>(payload: {
            mode: string;
            atPath: TreePath;
            value?: PickSpecifyDesignToken<Type, string, true, false>['$value'];
        }) => void;
    ...
    query: {
         ...
         */
        getTokenState: <Type extends SpecifyDesignTokenTypeName>(path: TreePath | string, options?: ViewSelectorOptions) => TokenState<Type> | undefined;
        /**
         ...
         */
        getTokenChildrenOf: (path: TreePath, depth?: number, options?: ViewSelectorOptions) => TokenState[];
        /**
         ...
         */
        getChildrenOf: (path: TreePath, depth?: number, options?: ViewSelectorOptions) => SDTFNodeState[];
        /**
         ...
         */
        getParentsOf: (path: TreePath, depth?: number, options?: ViewSelectorOptions) => SDTFNodeState[];
        /**
