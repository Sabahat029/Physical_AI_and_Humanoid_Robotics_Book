import { matchIsCollectionWhere, matchIsCollectionWhereWithAndWhere, matchIsCollectionWhereWithSelect, matchIsGroupWhere, matchIsGroupWhereWithAndWhere, matchIsGroupWhereWithSelect, matchIsTokenWhere, parseQuery, } from './index.js';
...
function traverseQuery(treeState, whereNodeOrMany, ctx, previousMatches) {
    if (Array.isArray(whereNodeOrMany)) {
        whereNodeOrMany.forEach(whereNode => traverseQuery(treeState, whereNode, ctx, previousMatches));
        return;
    }
    // Match nodes
    let matchedNodeStates = [];
    if (matchIsTokenWhere(whereNodeOrMany)) {
        const { token, atDepth, nestedIn, withTypes, withModes, containsAliases, withSourceIds, created, updated, } = whereNodeOrMany;
        if (atDepth !== undefined)
            throw new Error('Token where.atDepth is not implemented');
        if (nestedIn !== undefined)
            throw new Error('Token where.nestedIn is not implemented');
        const filterPreviousMatchesWithChildren = makePreviousMatchesWithChildrenFilter(previousMatches);
        ...
        matchedNodeStates = treeState
            ...
            .filter(tokenState => filterPreviousMatchesWithChildren(tokenState) &&
        ...
        if (atDepth !== undefined)
            throw new Error('Group where.atDepth is not implemented');
        if (nestedIn !== undefined)
            throw new Error('Group where.nestedIn is not implemented');
        matchedNodeStates = treeState
            .getAllGroupStates(viewOptions)
            .filter(groupState => makePreviousMatchesWithChildrenFilter(previousMatches)(groupState) &&
        ...
        if (matchIsGroupWhereWithAndWhere(whereNodeOrMany)) {
            ...
            traverseQuery(treeState, andWhere, ctx, matchedNodeStates);
        }
    }
    else if (matchIsCollectionWhere(whereNodeOrMany)) {
        const { collection, atDepth, nestedIn, withModes } = whereNodeOrMany;
        if (atDepth !== undefined)
            throw new Error('Collection where.atDepth is not implemented');
        if (nestedIn !== undefined)
            throw new Error('Collection where.nestedIn is not implemented');
        matchedNodeStates = treeState
            .getAllCollectionStates(viewOptions)
            .filter(collectionState => makePreviousMatchesWithChildrenFilter(previousMatches) &&
        ...
        if (matchIsCollectionWhereWithAndWhere(whereNodeOrMany)) {
            traverseQuery(treeState, whereNodeOrMany.andWhere, ctx, matchedNodeStates);
        }
    }
    else {
            ...
            if (parents === undefined) {
                ...
                if (collections === undefined) {
                    ...
                    if (typeof upToDepth === 'number') {
                        ...
                        throw new Error('Token select.parents.collections.upToDepth as string is not implemented');
                    }
                }
            ...
            if (children === undefined) {
                ...
                if (collections === undefined) {
                    ...
                    if (typeof upToDepth === 'number') {
                        ...
                        throw new Error('Group select.children.collections.upToDepth as string is not implemented');
                    }
                }
                else if ('equalToDepth' in collections) {
            ...
            if (parents === undefined) {
                ...
                if (collections === undefined) {
                    ...
                    if (typeof upToDepth === 'number') {
                        ...
                        throw new Error('Group select.parents.collections.upToDepth as string is not implemented');
                    }
                }
                else if ('equalToDepth' in collections) {
            ...
            if (children === undefined) {
                ...
                if (tokens === undefined) {
                    ...
                    if (typeof upToDepth === 'number') {
                        ...
                        throw new Error('Collection select.children.tokens.upToDepth as string is not implemented');
                    }
                }
                else if ('equalToDepth' in tokens) {
                ...
                if (groups === undefined) {
                    ...
                    if (typeof upToDepth === 'number') {
                        ...
                        throw new Error('Collection select.children.groups.upToDepth as string is not implemented');
                    }
                }
                else if ('equalToDepth' in groups) {
...
export function makeRunQuery(treeState) {
