import { z } from 'zod';
import { collectionSelectPropertySchema, collectionWhereBaseSchema, } from './definitions/collectionWhere.js';
...
import { shallowQuerySchema, shallowWhereWithSelectOrAndWhereSchema, } from './internals/shallowSchemas.js';
import { SDTFError } from '../../errors/index.js';
function parseWhere(whereCandidate, currentPath) {
    ...
    if (Array.isArray(whereCandidate)) {
        return whereCandidate.map((c, i) => parseWhere(c, currentPath.concat(i)));
    }
    ...
    if ('collection' in whereCandidate) {
        ...
        return {
            ...collectionWhereBase,
            andWhere: parseWhere(andWhere, currentPath.concat('collection')),
        };
    }
...
export function parseQuery(queryCandidate) {
